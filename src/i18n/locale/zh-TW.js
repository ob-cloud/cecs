...
export default {
  ...
  message: {
    ...
    rules: '{RULE, select, build{樓棟} floor{樓層} room{房間} user{用戶名} phone{手機號} pwd{密碼} role{角色} roleName{角色名稱} other{}} 不能為空',
  ...
  smart: {
    ...
    role: {
      title: '角色管理',
      search: '{FIELD, select, name{輸入用戶名} status{全部狀態} other{}}',
      ...
      tableField: '{FIELD, select, serial{序號} name{用戶名} status{狀態} action{操作} other{}}',
