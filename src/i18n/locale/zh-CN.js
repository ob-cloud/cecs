...
export default {
  ...
  message: {
    ...
    actionFail: '操作失败',
    actionSuccess: '操作成功',
    placeholder: '请{TYPE, select, input{输入} choose{选择} other{输入}}{PLACEHOLDER, select, build{楼栋} floor{楼层} room{房间} other{}}',
    rules: '{RULE, select, build{楼栋} floor{楼层} room{房间} user{用户名} phone{手机号} pwd{密码} role{角色} roleName{角色名称} other{}} 不能为空',
  ...
  smart: {
    ...
    obox: {
      ...
      placeholder: '{FIELD, select, lamp{灯开关} humidifier{温湿度} other{}}',
